...
} = require("../frontend/mystical/Arcane/tier_1/tier_1_index.js");
const {
  defineMonkSkills,
} = require("../frontend/mystical/Willpower/tier_1/monk.js");
const {
  defineSpiritSkills,
} = require("../frontend/mystical/Spirit/tier_1/young.js");
const {
  defineRankOneSkills,
} = require("../frontend/mystical/Presence/tier_1/rank_1.js");
...
const fullTemplate = {
  ...
  skills: {
    Strength: {
      ...
      "Muscle Control": {
        description:
          "Flex and control individual muscle groups to optimize strength output.",
      ...
      "Postural Strength": {
        description:
          "Maintain strong posture and balance under physical stress.",
        boost: ["armor:heavy"],
        effective_value: 0,
      },
      "Power Lift": {
      ...
      "Stone Stance": {
        description: "Become immovable once you plant your feet firmly.",
        boost: ["armor:heavy"],
        effective_value: 0,
      },
      "Weapon Mastery": {
