...
export function defineWaterSkills(db) {
  ...
  insertSkill(db, "Water", "Hydro Slip", {
    description:
  ...
  insertSkill(db, "Water", "Tideguard", {
    description:
  ...
  insertSkill(db, "Water", "Pressure Bloom", {
    description:
    ...
    effect: ({ level, arcane }) => WaterEquations.pressureBloom(level, arcane),
  });

  insertSkill(db, "Water", "Aqueous Bind", {
    description:
  ...
  insertSkill(db, "Water", "Geyser Shot", {
    description:
  ...
  insertSkill(db, "Water", "Current Sense", {
    description:
  ...
  insertSkill(db, "Water", "Tide Limbs", {
    description:
  ...
  insertSkill(db, "Water", "Undertow Grasp", {
    description:
    ...
    effect: ({ level, arcane }) => WaterEquations.undertowGrasp(level, arcane),
  });
}
