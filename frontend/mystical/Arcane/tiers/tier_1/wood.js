import { WoodEquations } from "../../../equations/wood-functions.js";
...
export function defineWoodSkills(db) {
  ...
  insertSkill(db, "Wood", "Living Armor", {
    description:
  ...
  insertSkill(db, "Wood", "Verdant Burst", {
    description:
  ...
  insertSkill(db, "Wood", "Spine Trap", {
    description:
  ...
  insertSkill(db, "Wood", "Nature’s Pulse", {
    description:
  ...
  insertSkill(db, "Wood", "Photosynthetic Bloom", {
    description:
  ...
  insertSkill(db, "Wood", "Overgrowth Ring", {
    description:
    ...
    effect: ({ level, arcane }) => WoodEquations.overgrowthRing(level, arcane),
  });
}
