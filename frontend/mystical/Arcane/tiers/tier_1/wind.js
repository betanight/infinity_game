import { WindEquations } from "../../../equations/wind-functions.js";
...
export function defineWindSkills(db) {
  ...
  insertSkill(db, "Wind", "Tailwind Step", {
    description:
  ...
  insertSkill(db, "Wind", "Buffer Zone", {
    description:
  ...
  insertSkill(db, "Wind", "Cyclone Burst", {
    description:
  ...
  insertSkill(db, "Wind", "Skyhook Lash", {
    description:
  ...
  insertSkill(db, "Wind", "Whisper Sense", {
    description:
  ...
  insertSkill(db, "Wind", "Reactive Boost", {
    description:
